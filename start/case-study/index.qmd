...
```{r}
#| label: collect-all-rf-predictions
rf_res |> 
  collect_predictions()
```
...
```{r}
#| label: collect-last-fit-metrics
last_rf_fit |> 
  collect_metrics()
```
