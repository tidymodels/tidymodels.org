...
1.  [Build a model](models/build_a_model.html)

2.  [Preprocess your data with recipes](recipes/preprocess_your_data_with_recipes.html)

3.  [Evaluate your model with resampling](resampling/evaluate_your_model_with_resampling.html)

4.  [Tune model parameters](tuning/tune_model_parameters.html)

5.  [A predictive modeling case study](case-study/a_predictive_modeling_case_study.html)
