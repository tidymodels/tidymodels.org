...
1.  [Build a model](models/)

2.  [Preprocess your data with recipes](recipes/)

3.  [Evaluate your model with resampling](resampling/)

4.  [Tune model parameters](tuning/)

5.  [A predictive modeling case study](case-study/)
