...
```{r}
#| label: sliding_index_rsplit_2_fallback
...
#| out.width: 700
#| fig.align: "center"
knitr::include_graphics("images/bootstrap-resample.jpg")
```
...
```{r}
#| label: bootstrap-regular
#| echo: false
#| out.width: 700
#| fig.align: "center"
knitr::include_graphics("images/bootstrap-regular.jpg")
```
...
```{r}
#| label: bootstrap-grouped
#| echo: false
#| out.width: 700
#| fig.align: "center"
knitr::include_graphics("images/bootstrap-grouped.jpg")
```
...
```{r}
#| label: bootstrap-modified
#| echo: false
#| out.width: 700
#| fig.align: "center"
knitr::include_graphics("images/bootstrap-modified.jpg")
```
