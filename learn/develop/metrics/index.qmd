...
```{r}
#| label: test-miss-rate-multiclass-fail
data("hpc_cv")
...
```{r}
#| label: define-finalize-estimator
#| error: false
...
```{r}
#| label: remove-binary-restriction
...
```{r}
#| label: test-miss-rate-multiclass
# two class
miss_rate_vec(two_class_example$truth, two_class_example$predicted)
