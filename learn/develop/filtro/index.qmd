...
```{r}
#| label: define-fit-method-score-aov
#| eval: false
...
```{r}
#| label: document-score-aov-fstat
#| eval: false
#' @name score_aov_pval
#' @export
score_aov_fstat <-
...
```{r}
#| label: access-pval-results
ames_aov_pval_res@results
```

```{r}
#| label: access-fstat-results
