...
If using the **Apache Spark** engine, wil will need to identify the data source 
and use that to create the splits. For this article, we will copy the 
`two_class_dat` dataset into the Spark session.
