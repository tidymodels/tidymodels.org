...
pkgs <- c("tidymodels", "agua", "baguette", "bonsai", "censored", "discrim",
          "multilevelmod", "plsmod", "poissonreg", "rules")
...
For data sets that _only_ work for three or more classes, we'll simulate:
...
To demonstrate regression, we'll subset some data. make a training/test split, and stanrdize the predictors: 
