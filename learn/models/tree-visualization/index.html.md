...
## Base R visualization with `plot.rpart()` {#plot-rpart}
...
## Visualization with `plot.party()` {#plot-party}
...
## Visualization with `rpart.plot()` {#rpart-plot}
...
## Visualization with `geom_parttree()` {#geom-parttree}
...
## Visualization with `fancyRpartPlot()` {#fancy-rpart}
