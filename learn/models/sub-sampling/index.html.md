...
#> 1 j_index binary     0.777    50 0.0199  pre0_mod0_post0
#> 2 roc_auc binary     0.949    50 0.00508 pre0_mod0_post0
```
:::
...
#>   .metric .estimator  mean     n std_err .config        
#>   <chr>   <chr>      <dbl> <int>   <dbl> <chr>          
#> 1 j_index binary     0.250    50 0.0288  pre0_mod0_post0
#> 2 roc_auc binary     0.953    50 0.00479 pre0_mod0_post0
```
:::
...
#>  ROSE         0.0-4   2021-06-14 CRAN (R 4.5.0)
