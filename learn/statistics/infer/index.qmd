...
```{r}
#| label: generate-null-f-theoretical
#| message: false
#| warning: false
...
```{r}
#| label: visualize-theoretical-null
#| message: false
#| warning: false
...
```{r}
#| label: visualize-both-distributions
#| message: false
#| warning: false
