...
```{r}
#| label: create-bootstrap-resamples
set.seed(27)
...
```{r}
#| label: define-fit-nls-bootstrap
...
```{r}
#| label: plot-coefficient-distributions
...
```{r}
#| label: define-fit-spline-bootstrap
