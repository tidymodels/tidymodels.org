...
The best regularized Cox model performs a little better than the parametric survival model, with an integrated Brier score of `r bi_best_cox` compared to `r bi_best_survreg` for the parametric model. The random forest yet a little better with an integrated Brier score of `r bi_best_rf`.
