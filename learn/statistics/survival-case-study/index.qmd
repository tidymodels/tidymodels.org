...
```{r}
#| label: load-building-complaints
...
```{r}
#| label: setup-validation-metrics
...
```{r}
#| label: brier-integrated-survreg
collect_metrics(survreg_res) %>% 
